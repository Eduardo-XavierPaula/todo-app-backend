...
const updatedTodoEntity = new TodoEntity({ task: 'new-task', isDone: 1 });
  ...
  describe('index', () => {
    ...
    it('should throw an exception', () => {
      ...
      jest
        ...
        .mockRejectedValueOnce(new Error('Erro no find'));

      //Assert
      expect(todoController.index()).rejects.toThrow(Error('Erro no find'));
    });
  });
